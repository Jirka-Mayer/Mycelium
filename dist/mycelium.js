...
var RichText = function () {
    _createClass(RichText, null, [{
        ...
        value: function createInstances(window, document, shroom) {
            ...
            for (var i = 0; i < elements.length; i++) {
                instances.push(new RichText(window, document, elements[i], shroom));
            }return instances;
        }
    }]);

    function RichText(window, document, element, shroom) {
    ...
    _createClass(RichText, [{
        ...
        value: function $createQuillInstance() {
            this.$quill = new Quill(this.$el, {
                theme: "snow",
                modules: {
                    toolbar: [["bold", "italic", "underline", "strike"], ["blockquote"], [{ "list": "ordered" }, { "list": "bullet" }], [{ "indent": "-1" }, { "indent": "+1" }], [{ "header": [1, 2, 3, 4, 5, 6, false] }], [{ "align": [] }], ["link", "image"], ["clean"]]
                }
            });
        ...
        value: function $onTextChange(delta, oldContents, source) {
            ...
            this.shroom.setData(this.key + "@rendered", this.$quill.root.innerHTML);
        }
    }]);
